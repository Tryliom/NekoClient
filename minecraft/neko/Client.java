...
public class Client {
	...
	public String strCreator = "�eCr�� par �f�lTryliom�e et �f�lMarie";
	...
	public void startClient() {
		...
		if(Utils.isHalloween() == true) {
			...
			switch (n) {
			case 0:
				Display.setTitle("Tu joues � la version divine de Neko :3");
				break;
			case 1:
				Display.setTitle("Waw quel joueur exp�riment� :o");
				break;
			case 2:
			...
			case 3:
				...
				break;
			case 4:
				Display.setTitle("Ne touche pas � �a ! NYAAAAAAH");
				break;
			case 5:
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (mc.thePlayer != null && Utils.verif == null) {
			...
			if (Utils.getRandInt(100)==1 && (QuestManager.getQM().getCurrent()==null && !QuestManager.getQM().isHasBegin())) {
				Utils.getRandQuest();
				Utils.addChat2("�aNouveau d�fi ! (Voir ici)", neko.prefixCmd+"startquest", "�7D�fi: "+QuestManager.getQM().getCurrent().getDesc()+"\n�aCliquez pour accepter le d�fi (Activer le cheat ou la commande que vous pensez �tre la bonne)", false, Chat.Click);
			}
		}
