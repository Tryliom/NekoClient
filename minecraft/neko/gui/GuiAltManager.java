...
public class GuiAltManager extends GuiScreen {
	 ...
	 private Minecraft mc = Minecraft.getMinecraft();
	  ...
	  {
	    try {
	    	ArrayList<Account> list2 = (ArrayList<Account>) this.accounts.clone();
			this.accounts.clear();
			for (Object o : Utils.getAllAccount()) {
				...
				for (Account a : list2) {
					if (a.getEmail().equalsIgnoreCase(name) && a.getPass().equalsIgnoreCase(pass) && a.getUsername()!=null && !a.getUsername().isEmpty()) {
						alt.setUsername(a.getUsername());
					}
				}
