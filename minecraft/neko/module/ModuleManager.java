...
public class ModuleManager {
	...
	public ModuleManager() {	
		...
		Utils.getRank("Morpheus").setDesc("Satsumaimo wa kaosu no kono sekai no ōdearu... Gyōretsu ga fuhen-tekidesu");
		...
		Utils.getRank("Goku").setDesc("Neko-jō de mottomo kyōryokude wa nai to iu Goku-san");
