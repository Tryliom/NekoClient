...
public abstract class BlockLiquid extends Block
{
    ...
    {
        return (p_176209_2_ && ((Integer)state.getValue(LEVEL)).intValue() == 0) || (Utils.isToggle("Jesus") && !Minecraft.getMinecraft().thePlayer.isSneaking() && Minecraft.getMinecraft().thePlayer.fallDistance<3);
    }
    ...
    {
        return (Utils.isToggle("Jesus") && !Minecraft.getMinecraft().thePlayer.isSneaking() && Minecraft.getMinecraft().thePlayer.fallDistance<3) ? 
        	      AxisAlignedBB.fromBounds(pos.getX() + this.minX, pos.getY() + this.minY, 
        	    	      pos.getZ() + this.minZ, pos.getX() + this.maxX, pos.getY() + this.maxY, 
        	    	      pos.getZ() + this.maxZ) : null;
    }
