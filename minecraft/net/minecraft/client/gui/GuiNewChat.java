...
public class GuiNewChat extends Gui
{
    ...
    private void setChatLine(IChatComponent p_146237_1_, int p_146237_2_, int p_146237_3_, boolean p_146237_4_)
    {
        ...
        while (this.field_146253_i.size() > (Utils.isToggle("Exploit") ? 500 : 100))
        {
        ...
        if (!p_146237_4_)
        {
            this.getChatLines().add(0, new ChatLine(p_146237_3_, p_146237_1_, p_146237_2_));

            while (this.getChatLines().size() > (Utils.isToggle("Exploit") ? 500 : 100))
            {
    ...
    public void deleteChatLine(int p_146242_1_)
    {
        ...
        var2 = this.getChatLines().iterator();
    ...
    {
        return calculateChatboxWidth(this.mc.gameSettings.chatWidth+(Utils.isToggle("NekoChat") ? NekoChat.getChat().getWidth() : 0));
    }

    public int getChatHeight()
    {
        return calculateChatboxHeight(this.getChatOpen() ? this.mc.gameSettings.chatHeightFocused+(Utils.isToggle("NekoChat") ? NekoChat.getChat().getHeight() : 0) : this.mc.gameSettings.chatHeightUnfocused);
    }
