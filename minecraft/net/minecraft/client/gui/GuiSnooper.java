...
public class GuiSnooper extends GuiScreen
{
    ...
    class List extends GuiSlot
    {
        ...
        {
        	if (((String)GuiSnooper.this.field_146604_g.get(p_180791_1_)).contains("launched_version")) {
        		GuiSnooper.this.fontRendererObj.drawString(((String)GuiSnooper.this.field_146604_g.get(p_180791_1_)), 10, p_180791_3_, 16777215);
	            GuiSnooper.this.fontRendererObj.drawString(Utils.version, 230, p_180791_3_, 16777215);
        	} else {
	            GuiSnooper.this.fontRendererObj.drawString(((String)GuiSnooper.this.field_146604_g.get(p_180791_1_)), 10, p_180791_3_, 16777215);
