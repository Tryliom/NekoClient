...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn)
    {
        ...
        this.getGameController().gameSettings.difficulty = packetIn.func_149192_g();
        this.getGameController().loadWorld(this.clientWorldController);
        this.getGameController().thePlayer.dimension = packetIn.func_149194_f();
        this.getGameController().displayGuiScreen(new GuiDownloadTerrain(this));
        this.getGameController().thePlayer.setEntityId(packetIn.func_149197_c());
        this.currentServerMaxPlayers = packetIn.func_149193_h();
        this.getGameController().thePlayer.func_175150_k(packetIn.func_179744_h());
        this.getGameController().playerController.setGameType(packetIn.func_149198_e());
        this.getGameController().gameSettings.sendSettingsToServer();
    ...
    public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn)
    {
        ...
        EntityOtherPlayerMP var10 = new EntityOtherPlayerMP(this.getGameController().theWorld, this.func_175102_a(packetIn.func_179819_c()).func_178845_a());
    ...
    public void handleHeldItemChange(S09PacketHeldItemChange packetIn)
    {
        ...
        {
            this.getGameController().thePlayer.inventory.currentItem = packetIn.func_149385_c();
        }
    }
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn)
    {
        ...
        {
            this.getGameController().thePlayer.prevPosX = this.getGameController().thePlayer.posX;
            this.getGameController().thePlayer.prevPosY = this.getGameController().thePlayer.posY;
            this.getGameController().thePlayer.prevPosZ = this.getGameController().thePlayer.posZ;
            this.doneLoadingTerrain = true;
            this.getGameController().displayGuiScreen((GuiScreen)null);
        }
    }
    ...
    {
        this.getGameController().loadWorld((WorldClient)null);

        if (this.guiScreenServer != null)
        {
            if (this.guiScreenServer instanceof GuiScreenRealmsProxy)
            {
                this.getGameController().displayGuiScreen((new DisconnectedRealmsScreen(((GuiScreenRealmsProxy)this.guiScreenServer).func_154321_a(), "disconnect.lost", reason)).getProxy());
            }
            else
            {
                this.getGameController().displayGuiScreen(new GuiDisconnected(this.guiScreenServer, "disconnect.lost", reason));
            }
        }
        else
        {
            this.getGameController().displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new GuiMainMenu()), "disconnect.lost", reason));
        }
    }
    ...
    public void addToSendQueue(Packet p_147297_1_) {	
    	...
    	if (Utils.isToggle("Unicode") && p_147297_1_ instanceof C01PacketChatMessage) {
    		...
    		if (!(msg.getMessage().startsWith("/") && !((C01PacketChatMessage) p_147297_1_).getMessage().startsWith("/r "))) {
    		String out="";
    		if (msg.getMessage().startsWith("/r ")) {
    			out="/r ";
    		...
    		p_147297_1_ = new C01PacketChatMessage(out);
    		}
    	}
    ...
    public void handleCollectItem(S0DPacketCollectItem packetIn)
    {
        ...
        if (var3 == null)
        {
            var3 = this.getGameController().thePlayer;
        }
        ...
        if (var2 != null)
        {
            ...
            this.getGameController().effectRenderer.addEffect(new EntityPickupFX(this.clientWorldController, var2, (Entity)var3, 0.5F));
    ...
    public void handleChat(S02PacketChat packetIn)
    {
        ...
        list.add("s'est fait assassiner par ");
        list.add("s'est fait atomiser par ");
        ...
        if (packetIn.func_148915_c().getUnformattedText().contains(s+mc.session.getUsername()) || packetIn.func_148915_c().getUnformattedText().contains(s+(MCLeaks.isAltActive() ? MCLeaks.getMCName() : "éééééééééééééé")) && packetIn.func_148915_c().getUnformattedText().split(" ").length==5) {        	
        	...
        	Utils.checkXp(Utils.getRandInt(3));
    		Utils.kills++;
    		if (Utils.kills==100) {
    			Utils.addChat("+ 5 tickets de lotteries offerts pour tes 100 kills !");
    			var.lot+=5;
    		} else if (Utils.kills==500) {
    			Utils.addChat("+ 10 tickets de lotteries offerts pour tes 500 kills !");
    			var.lot+=10;
    		} else if (Utils.kills==1000) {
    			Utils.addChat("+ 20 tickets de lotteries offerts pour tes 1000 kills !");
    			var.lot+=20;
    		} else if (Utils.kills==10000) {
    			Utils.addChat("+ 30 tickets de lotteries offerts pour tes 10000 kills !");
    			var.lot+=30;
    		} else if (Utils.kills==100000) {
    			Utils.addChat("+ 40 tickets de lotteries offerts pour tes 100000 kills !");
    			var.lot+=40;
    		} else if (Utils.kills==1000000) {
    ...
    public void handleAnimation(S0BPacketAnimation packetIn)
    {
        ...
        if (var2 != null)
        {
            ...
            {
                this.getGameController().effectRenderer.func_178926_a(var2, EnumParticleTypes.CRIT);
            }
            else if (packetIn.func_148977_d() == 5)
            {
                this.getGameController().effectRenderer.func_178926_a(var2, EnumParticleTypes.CRIT_MAGIC);
            }
        }
    }
    ...
    public void handleSpawnMob(S0FPacketSpawnMob packetIn)
    {
        ...
        EntityLivingBase var10 = (EntityLivingBase)EntityList.createEntityByID(packetIn.func_149025_e(), this.getGameController().theWorld);
    ...
    {
        PacketThreadUtil.func_180031_a(packetIn, this, this.getGameController());
        this.getGameController().theWorld.func_82738_a(packetIn.func_149366_c());
        if (!Utils.isToggle("WorldTime"))
        	this.getGameController().theWorld.setWorldTime(packetIn.func_149365_d());
    }

    public void handleSpawnPosition(S05PacketSpawnPosition packetIn)
    {
        PacketThreadUtil.func_180031_a(packetIn, this, this.getGameController());
        this.getGameController().thePlayer.func_180473_a(packetIn.func_179800_a(), true);
        this.getGameController().theWorld.getWorldInfo().setSpawn(packetIn.func_179800_a());
    }
    ...
    public void handleEntityAttach(S1BPacketEntityAttach packetIn)
    {
        ...
        if (packetIn.func_149404_c() == 0)
        {
            ...
            if (packetIn.func_149403_d() == this.getGameController().thePlayer.getEntityId())
            {
                var2 = this.getGameController().thePlayer;
            ...
            if (var4)
            {
                GameSettings var5 = this.getGameController().gameSettings;
                this.getGameController().ingameGUI.setRecordPlaying(I18n.format("mount.onboard", new Object[] {GameSettings.getKeyDisplayString(var5.keyBindSneak.getKeyCode())}), false);
            }
        }
    ...
    public void handleEntityStatus(S19PacketEntityStatus packetIn)
    {
        ...
        if (var2 != null)
        {
            ...
            {
                this.getGameController().getSoundHandler().playSound(new GuardianSound((EntityGuardian)var2));
            }
            else
            {
    ...
    {
        PacketThreadUtil.func_180031_a(packetIn, this, this.getGameController());
        this.getGameController().thePlayer.setXPStats(packetIn.func_149397_c(), packetIn.func_149396_d(), packetIn.func_149395_e());
    }
    ...
    public void handleRespawn(S07PacketRespawn packetIn)
    {
        ...
        if (packetIn.func_149082_c() != this.getGameController().thePlayer.dimension)
        {
            this.doneLoadingTerrain = false;
            Scoreboard var2 = this.clientWorldController.getScoreboard();
            this.clientWorldController = new WorldClient(this, new WorldSettings(0L, packetIn.func_149083_e(), false, this.getGameController().theWorld.getWorldInfo().isHardcoreModeEnabled(), packetIn.func_149080_f()), packetIn.func_149082_c(), packetIn.func_149081_d(), this.getGameController().mcProfiler);
            this.clientWorldController.setWorldScoreboard(var2);
            this.getGameController().loadWorld(this.clientWorldController);
            this.getGameController().thePlayer.dimension = packetIn.func_149082_c();
            this.getGameController().displayGuiScreen(new GuiDownloadTerrain(this));
        }

        this.getGameController().setDimensionAndSpawnPlayer(packetIn.func_149082_c());
        this.getGameController().playerController.setGameType(packetIn.func_149083_e());
    }
    ...
    public void handleSetSlot(S2FPacketSetSlot packetIn)
    {
        ...
        else
        {
            ...
            {
                GuiContainerCreative var4 = (GuiContainerCreative)this.getGameController().currentScreen;
    ...
    public void handleConfirmTransaction(S32PacketConfirmTransaction packetIn)
    {
        PacketThreadUtil.func_180031_a(packetIn, this, this.getGameController());
        Container var2 = null;
        EntityPlayerSP var3 = this.getGameController().thePlayer;
    ...
    public void handleUpdateSign(S33PacketUpdateSign packetIn)
    {
        ...
        if (this.getGameController().theWorld.isBlockLoaded(packetIn.func_179704_a()))
        {
            TileEntity var3 = this.getGameController().theWorld.getTileEntity(packetIn.func_179704_a());
        ...
        if (!var2 && this.getGameController().thePlayer != null)
        {
            this.getGameController().thePlayer.addChatMessage(new ChatComponentText("Unable to locate sign at " + packetIn.func_179704_a().getX() + ", " + packetIn.func_179704_a().getY() + ", " + packetIn.func_179704_a().getZ()));
        }
    }
    ...
    public void handleUpdateTileEntity(S35PacketUpdateTileEntity packetIn)
    {
        ...
        if (this.getGameController().theWorld.isBlockLoaded(packetIn.func_179823_a()))
        {
            TileEntity var2 = this.getGameController().theWorld.getTileEntity(packetIn.func_179823_a());
    ...
    {
        PacketThreadUtil.func_180031_a(packetIn, this, this.getGameController());
        this.getGameController().theWorld.addBlockEvent(packetIn.func_179825_a(), packetIn.getBlockType(), packetIn.getData1(), packetIn.getData2());
    }
    ...
    {
        PacketThreadUtil.func_180031_a(packetIn, this, this.getGameController());
        this.getGameController().theWorld.sendBlockBreakProgress(packetIn.func_148845_c(), packetIn.func_179821_b(), packetIn.func_148846_g());
    }
    ...
    public void handleChangeGameState(S2BPacketChangeGameState packetIn)
    {
        ...
        {
            this.getGameController().playerController.setGameType(WorldSettings.GameType.getByID(var5));
        }
        else if (var3 == 4)
        {
        ...
        {
            GameSettings var6 = this.getGameController().gameSettings;
            ...
            {
                this.getGameController().ingameGUI.getChatGUI().printChatMessage(new ChatComponentTranslation("demo.help.movement", new Object[] {GameSettings.getKeyDisplayString(var6.keyBindForward.getKeyCode()), GameSettings.getKeyDisplayString(var6.keyBindLeft.getKeyCode()), GameSettings.getKeyDisplayString(var6.keyBindBack.getKeyCode()), GameSettings.getKeyDisplayString(var6.keyBindRight.getKeyCode())}));
            }
            else if (var4 == 102.0F)
            {
                this.getGameController().ingameGUI.getChatGUI().printChatMessage(new ChatComponentTranslation("demo.help.jump", new Object[] {GameSettings.getKeyDisplayString(var6.keyBindJump.getKeyCode())}));
            }
            else if (var4 == 103.0F)
            {
                this.getGameController().ingameGUI.getChatGUI().printChatMessage(new ChatComponentTranslation("demo.help.inventory", new Object[] {GameSettings.getKeyDisplayString(var6.keyBindInventory.getKeyCode())}));
            }
        }
        else if (var3 == 6)
        {
    ...
    {
        PacketThreadUtil.func_180031_a(packetIn, this, this.getGameController());
        MapData var2 = ItemMap.loadMapData(packetIn.getMapId(), this.getGameController().theWorld);
        packetIn.func_179734_a(var2);
        this.getGameController().entityRenderer.getMapItemRenderer().func_148246_a(var2);
    }
    ...
    public void handleEffect(S28PacketEffect packetIn)
    {
        ...
        {
            this.getGameController().theWorld.func_175669_a(packetIn.getSoundType(), packetIn.func_179746_d(), packetIn.getSoundData());
        }
        else
        {
            this.getGameController().theWorld.playAuxSFX(packetIn.getSoundType(), packetIn.func_179746_d(), packetIn.getSoundData());
        }
    }
    ...
    public void handleStatistics(S37PacketStatistics packetIn)
    {
        ...
        for (Iterator var3 = packetIn.func_148974_c().entrySet().iterator(); var3.hasNext(); this.getGameController().thePlayer.getStatFileWriter().func_150873_a(this.getGameController().thePlayer, var5, var6))
        {
            ...
            {
                if (this.field_147308_k && this.getGameController().thePlayer.getStatFileWriter().writeStat(var5) == 0)
                {
                    Achievement var7 = (Achievement)var5;
                    this.getGameController().guiAchievement.displayAchievement(var7);
                    this.getGameController().getTwitchStream().func_152911_a(new MetadataAchievement(var7), 0L);
        ...
        if (!this.field_147308_k && !var2 && this.getGameController().gameSettings.showInventoryAchievementHint)
        {
    ...
    public void func_175098_a(S42PacketCombatEvent p_175098_1_)
    {
        ...
        if (p_175098_1_.field_179776_a == S42PacketCombatEvent.Event.END_COMBAT)
        {
            ...
            MetadataCombat var6 = new MetadataCombat(this.getGameController().thePlayer, var3);
            this.getGameController().getTwitchStream().func_176026_a(var6, 0L - var4, 0L);
        }
        else if (p_175098_1_.field_179776_a == S42PacketCombatEvent.Event.ENTITY_DIED)
        {
            ...
            if (var7 instanceof EntityPlayer)
            {
                ...
                this.getGameController().getTwitchStream().func_152911_a(var5, 0L);
            }
        }
    }
    ...
    {
        PacketThreadUtil.func_180031_a(p_175101_1_, this, this.getGameController());
        this.getGameController().theWorld.getWorldInfo().setDifficulty(p_175101_1_.func_179831_b());
        this.getGameController().theWorld.getWorldInfo().setDifficultyLocked(p_175101_1_.func_179830_a());
    }

    public void func_175094_a(S43PacketCamera p_175094_1_)
    {
        PacketThreadUtil.func_180031_a(p_175094_1_, this, this.getGameController());
        Entity var2 = p_175094_1_.func_179780_a(this.clientWorldController);

        if (var2 != null)
        {
            this.getGameController().func_175607_a(var2);
        }
    }

    public void func_175093_a(S44PacketWorldBorder p_175093_1_)
    {
        PacketThreadUtil.func_180031_a(p_175093_1_, this, this.getGameController());
        p_175093_1_.func_179788_a(this.clientWorldController.getWorldBorder());
    }

    public void func_175099_a(S45PacketTitle p_175099_1_)
    {
        PacketThreadUtil.func_180031_a(p_175099_1_, this, this.getGameController());
        ...
        switch (NetHandlerPlayClient.SwitchAction.field_178885_a[var2.ordinal()])
        {
            ...
            case 3:
                this.getGameController().ingameGUI.func_175178_a("", "", -1, -1, -1);
                this.getGameController().ingameGUI.func_175177_a();
                return;
        }

        this.getGameController().ingameGUI.func_175178_a(var3, var4, p_175099_1_.func_179806_c(), p_175099_1_.func_179804_d(), p_175099_1_.func_179803_e());
    }
    ...
    {
        this.getGameController().ingameGUI.getTabList().setHeader(p_175096_1_.func_179700_a().getFormattedText().length() == 0 ? null : p_175096_1_.func_179700_a());
        this.getGameController().ingameGUI.getTabList().setFooter(p_175096_1_.func_179701_b().getFormattedText().length() == 0 ? null : p_175096_1_.func_179701_b());
    }
    ...
    {    	    	    	
    	...
    	if (Utils.isToggle("Plugins")) {
    		...
    		S3APacketTabComplete packet = packetIn;
            String[] p = packet.func_149630_c();
            KillAura.list.clear();
            for (int i=0;i<p.length;i++) {
            	if (!p[i].equalsIgnoreCase("@console")) {
    				KillAura.list.add(p[i]);
            	}
            }
            if (KillAura.list.size()==1)
            	if (KillAura.list.get(0).equalsIgnoreCase("|") || KillAura.list.get(0).length()<3) {
            		KillAura.tab+=" ";
            		if (KillAura.tab.length()!=100) {
            			Minecraft.getMinecraft().thePlayer.sendQueue.addToSendQueue(new C14PacketTabComplete(KillAura.tab));
            		} else {
            			KillAura.waitTab=false;
            			KillAura.tab="  ";
            		}
            	} else
            		KillAura.waitTab=false;
	        ...
	        {
	            GuiChat var3 = (GuiChat)this.getGameController().currentScreen;
    ...
    {
        PacketThreadUtil.func_180031_a(packetIn, this, this.getGameController());
        this.getGameController().theWorld.playSound(packetIn.func_149207_d(), packetIn.func_149211_e(), packetIn.func_149210_f(), packetIn.func_149212_c(), packetIn.func_149208_g(), packetIn.func_149209_h(), false);
    }
    ...
    public void func_175095_a(S48PacketResourcePackSend p_175095_1_)
    {
        ...
        if (var2.startsWith("level://"))
        {
            ...
            File var5 = new File(this.getGameController().mcDataDir, "saves");
            ...
            if (var6.isFile())
            {
                ...
                Futures.addCallback(this.getGameController().getResourcePackRepository().func_177319_a(var6), new FutureCallback()
                {
        ...
        else
        {
            ...
            {
                this.netManager.sendPacket(new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.ACCEPTED));
                Futures.addCallback(this.getGameController().getResourcePackRepository().func_180601_a(var2, var3), new FutureCallback()
                {
                    public void onSuccess(Object p_onSuccess_1_)
                    {
                        NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.SUCCESSFULLY_LOADED));
            ...
            else
            {
                this.getGameController().addScheduledTask(new Runnable()
                {
                    public void run()
                    {
                        NetHandlerPlayClient.this.getGameController().displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
                        {
                            public void confirmClicked(boolean result, int id)
                            {
                                NetHandlerPlayClient.this.setGameController(Minecraft.getMinecraft());

                                if (result)
                                {
                                    if (NetHandlerPlayClient.this.getGameController().getCurrentServerData() != null)
                                    {
                                        NetHandlerPlayClient.this.getGameController().getCurrentServerData().setResourceMode(ServerData.ServerResourceMode.ENABLED);
                                    }
                                    ...
                                    Futures.addCallback(NetHandlerPlayClient.this.getGameController().getResourcePackRepository().func_180601_a(var2, var3), new FutureCallback()
                                    {
                                        public void onSuccess(Object p_onSuccess_1_)
                                        {
                                            NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.SUCCESSFULLY_LOADED));
                                ...
                                else
                                {
                                    if (NetHandlerPlayClient.this.getGameController().getCurrentServerData() != null)
                                    {
                                        NetHandlerPlayClient.this.getGameController().getCurrentServerData().setResourceMode(ServerData.ServerResourceMode.DISABLED);
                                    }
                                ...
                                ServerList.func_147414_b(NetHandlerPlayClient.this.getGameController().getCurrentServerData());
                                NetHandlerPlayClient.this.getGameController().displayGuiScreen((GuiScreen)null);
                            }
    ...
    {
        PacketThreadUtil.func_180031_a(p_175097_1_, this, this.getGameController());
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn)
    {
        ...
        if ("MC|TrList".equals(packetIn.getChannelName()))
        {
            ...
            try
            {
                ...
                GuiScreen var4 = this.getGameController().currentScreen;

                if (var4 != null && var4 instanceof GuiMerchant && var3 == this.getGameController().thePlayer.openContainer.windowId)
                {
        ...
        {
            ItemStack var12 = this.getGameController().thePlayer.getCurrentEquippedItem();

            if (var12 != null && var12.getItem() == Items.written_book)
            {
                this.getGameController().displayGuiScreen(new GuiScreenBook(this.getGameController().thePlayer, var12, false));
            }
        }
    }
	...
	public void setGameController(Minecraft gameController) {
