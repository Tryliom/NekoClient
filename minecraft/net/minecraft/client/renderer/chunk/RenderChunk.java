...
public class RenderChunk
{
    ...
    public void func_178581_b(float p_178581_1_, float p_178581_2_, float p_178581_3_, ChunkCompileTaskGenerator p_178581_4_)
    {
        ...
        if (!var9.extendedLevelsInChunkCache())
        {
            ...
            boolean forgeHasTileEntity = Reflector.ForgeBlock_hasTileEntity.exists();
            ...
            while (var11.hasNext())
            {
                ...
                if (var23)
                {
                    TileEntity var24 = var9.getTileEntity(new BlockPos(var20));

                    if (var24 != null && TileEntityRendererDispatcher.instance.hasSpecialRenderer(var24))
                    {
                        var5.func_178490_a(var24);
                    }
                }

                EnumWorldBlockLayer var26 = var22.getBlockLayer();
                int var16 = var26.ordinal();

                if (var22.getRenderType() != -1)
                {
                    WorldRenderer var17 = p_178581_4_.func_178545_d().func_179039_a(var16);
                    var17.setBlockLayer(var26);

                    if (!var5.func_178492_d(var26))
                    {
                        var5.func_178493_c(var26);
                        this.func_178573_a(var17, var7);
                    }

                    if (Minecraft.getMinecraft().getBlockRendererDispatcher().func_175018_a(var21, var20, var9, var17))
                    {
                        var5.func_178486_a(var26);
                    }
                }
            }

            EnumWorldBlockLayer[] var221 = EnumWorldBlockLayer.values();
            int var231 = var221.length;

            for (int var241 = 0; var241 < var231; ++var241)
            {
                EnumWorldBlockLayer var25 = var221[var241];

                if (var5.func_178492_d(var25))
                {
                    this.func_178584_a(var25, p_178581_1_, p_178581_2_, p_178581_3_, p_178581_4_.func_178545_d().func_179038_a(var25), var5);
                }
            }
        }
