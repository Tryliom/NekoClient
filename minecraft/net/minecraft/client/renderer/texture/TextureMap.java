    ...
    public void loadTextureAtlas(IResourceManager p_110571_1_)
    {
        ...
        while (true)
        {
            ...
            while (var6.hasNext())
            {
                ...
                if (!var26.hasCustomLoader(p_110571_1_, var27))
                {
                    try
                    {
                        ...
                        BufferedImage[] var32 = new BufferedImage[1 + this.mipmapLevels];
                        var32[0] = TextureUtil.func_177053_a(var30.getInputStream());
                        ...
                        if (sheetWidth != null)
                        {
                            ...
                            {
                                int it = var32[0].getWidth();
                                listSprites = var32[0].getHeight();
                            ...
                            while (it1.hasNext())
                            {
                                ...
                                if (listSprites > 0 && listSprites < var32.length - 1 && var32[listSprites] == null)
                                {
                                    ResourceLocation tas = this.completeResourceLocation(var27, listSprites);

                                    try
                                    {
                                        var32[listSprites] = TextureUtil.func_177053_a(p_110571_1_.getResource(tas).getInputStream());
                                    }
                        ...
                        var26.func_180598_a(var32, sheetHeight1);
                    }
            ...
            while (var302.hasNext())
            {
                ...
                {
                    CrashReport listSprites1 = CrashReport.makeCrashReport(var22, "Stitching texture atlas");
