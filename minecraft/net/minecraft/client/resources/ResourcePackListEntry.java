...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry
{
    ...
    protected final GuiScreenResourcePacks guiScreenRessourcepacks;

    public ResourcePackListEntry(GuiScreenResourcePacks p_i45051_1_)
    {
        this.guiScreenRessourcepacks = p_i45051_1_;
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
        ...
        String var13 = this.TexturePackName();
        ...
        List var11 = this.mc.fontRendererObj.listFormattedStringToWidth(this.TexturePackDescription(), 157);
    ...
    protected abstract String TexturePackDescription();

    protected abstract String TexturePackName();
    ...
    {
        return !this.guiScreenRessourcepacks.hasResourcePackEntry(this);
    }
    ...
    {
        List var1 = this.guiScreenRessourcepacks.getListContaining(this);
    ...
    public boolean mousePressed(int slotIndex, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_)
    {
        if (this.func_148310_d() && p_148278_5_ <= 32)
        {
            if (this.func_148309_e())
            {
                this.guiScreenRessourcepacks.getListContaining(this).remove(this);
                this.guiScreenRessourcepacks.getSelectedResourcePacks().add(0, this);
                this.guiScreenRessourcepacks.markChanged();
                return true;
            }
            ...
            {
                this.guiScreenRessourcepacks.getListContaining(this).remove(this);
                this.guiScreenRessourcepacks.getAvailableResourcePacks().add(0, this);
                this.guiScreenRessourcepacks.markChanged();
                return true;
            }
            ...
            {
                var7 = this.guiScreenRessourcepacks.getListContaining(this);
