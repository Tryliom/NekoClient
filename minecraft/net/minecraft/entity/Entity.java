...
import neko.module.modules.Safewalk;
import neko.module.modules.Scaffold;
...
public abstract class Entity implements ICommandSender
{
        ...
        else
        {
            ...
            if (this.canTriggerWalking() && !var19 && this.ridingEntity == null)
            {
                ...
                if (this.distanceWalkedOnStepModified > (float)this.nextStepDistance && var60.getMaterial() != Material.air)
                {
                    ...
                    //TODO: Dolphin
                    if (this.isInWater() && !Utils.isToggle("Dolphin"))
                    {
    ...
    public boolean isInRangeToRenderDist(double distance)
    {
        ...
        var3 *= (Utils.isToggle("Exploit") ? 256D : 64D) * this.renderDistanceWeight;
    ...
    {
    	//TODO: Velocity
    	if (this != Minecraft.getMinecraft().thePlayer || !Utils.isToggle("Velocity")) {
    		this.motionX = x;
			this.motionY = y;
			this.motionZ = z;
    	} else {
    		Velocity v = Velocity.getVelocity();
	        this.motionX = x*v.getHcoeff();
	        this.motionY = y*v.getVcoeff();
	        this.motionZ = z*v.getHcoeff();
    	}
    }
