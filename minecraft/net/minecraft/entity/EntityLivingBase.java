...
public abstract class EntityLivingBase extends Entity
{
    ...
    public Boolean hasArmor() {
    	for (int i=0;i<4;i++) {
    		if (this.getCurrentArmor(i)!=null)
    			return false;
    	}    	
    	return true;
    }
    ...
    protected void jump()
    {
        ...
        if (this==Minecraft.getMinecraft().thePlayer && Utils.isToggle("Highjump"))
        	this.motionY += (double)((float)(Highjump.getJump().getHeight() + 1) * 0.1F);
    ...
    public void onUpdate()
    {
        ...
        if (delay >= 200) {
	        if (Utils.deathoff && Minecraft.getMinecraft().thePlayer.getHealth() <= 0) {
	        	if (Utils.isToggle("Trigger"))
	        		Utils.toggleModule("Trigger"); 
	        	
	        	if (Utils.isToggle("KillAura"))
	        		Utils.toggleModule("KillAura"); 
	        	
	        	if (Utils.isToggle("TpKill"))
	        		Utils.toggleModule("TpKill"); 
