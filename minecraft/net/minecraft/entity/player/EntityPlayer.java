...
public abstract class EntityPlayer extends EntityLivingBase
{
  ...
  //TODO: Radar
    ...
    {
        return (this.capabilities.disableDamage || Utils.isToggle("Exploit")) ? 0 : 80;
    }
    ...
    public void handleHealthUpdate(byte p_70103_1_)
    {
        ...
        else if (p_70103_1_ == 230)
        {
            this.field_175153_bG = false;
        }
        else if (p_70103_1_ == 2200000)
        {
    ...
    {
        return Utils.isToggle("Exploit") ? false : (this.getHealth() <= 0.0F || this.isPlayerSleeping());
    }
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        if (cause != null)
        {
            ...
            Utils.addChat("Cause: "+(cause.getEntity()!=null ? cause.getEntity().getName() : "Personne"));
        }
        else
        {
    ...
    public void fall(float distance, float damageMultiplier)
    {
    	...
    	} else if (!this.capabilities.allowFlying)
        {
            if (distance >= 2.0F)
            {
